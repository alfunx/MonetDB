...
mal_export str BKCappend_wrap_batlist(bat *r, const bat *ibl_bid, const bat *ubl_bid);
...
mal_export str BKCappend_force_wrap_batlist(bat *r, const bat *ibl_bid, const bat *ubl_bid, const bit *force);
