...
str
CMDbatGSQRT(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci)
{
	(void) cntxt;

	return CMDbatBINARY2(mb, stk, pci, BATcalcgsqrt, NULL, NULL,
						 calctype, 0, "batcalc.gsqrt_noerror");
}

mal_export str CMDbatGSQRTsignal(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci);

str
CMDbatGSQRTsignal(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci)
{
	(void) cntxt;

	return CMDbatBINARY2(mb, stk, pci, BATcalcgsqrt, NULL, NULL,
						 calctype, 1, "batcalc.gsqrt");
}
...
mal_export str CMDconvert_wrd(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci);
mal_export str CMDconvertsignal_wrd(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci);
...
str
CMDbatCPDsignal(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci)
{
	int argc = pci->argc;
	int tp;
	...
	// result BAT
	obid = getArgReference_bat(stk, pci, 0);
	obat = BATnew(TYPE_void, abat->T->type, argc - 2, TRANSIENT);
	oval = (double*) Tloc(obat, BUNfirst(obat));
