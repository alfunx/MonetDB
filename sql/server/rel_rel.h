...
extern sql_rel *rel_matrixyintercept(sql_allocator *sa, sql_rel *l);

extern sql_rel *rel_matrixadd(sql_allocator *sa, sql_rel *l, sql_rel *r);
extern sql_rel *rel_matrixsub(sql_allocator *sa, sql_rel *l, sql_rel *r);
